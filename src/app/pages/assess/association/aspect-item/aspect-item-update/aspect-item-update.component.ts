...
@Component({
  selector: 'nl-aspect-item-update',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, DropdownModule],
  templateUrl: './aspect-item-update.component.html',
  styleUrls: ['./aspect-item-update.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AspectItemUpdateComponent implements OnInit {
  editForm: FormGroup;
  aspectItem: any;
